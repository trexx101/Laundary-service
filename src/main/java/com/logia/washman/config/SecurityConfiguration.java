package com.logia.washman.config;

import com.logia.washman.security.*;
import com.logia.washman.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/manage/**").hasAuthority(AuthoritiesConstants.ADMIN)

...
import com.logia.washman.domain.enumeration.Gender;
...
public class Customer implements Serializable {
    ...
    public void setLocation(Coordinate coordinate) {
        if (this.location != null) {
            this.location.setCustomer(null);
        }
        if (coordinate != null) {
            coordinate.setCustomer(this);
        }
        this.location = coordinate;
    }

    public Customer location(Coordinate coordinate) {

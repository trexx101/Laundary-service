...
import com.logia.washman.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link com.logia.washman.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerResource {
    ...
    public List<Customer> getAllCustomers(
        ...
        if ("location-is-null".equals(filter)) {
            log.debug("REST request to get all Customers where location is null");
    ...
    /**
     * {@code GET  /customerByUser/:id} : get the "id" user.
     *
    ...
    public ResponseEntity<Customer> getCustomerByUser(@PathVariable Long id) {
        log.debug("REST request to get customer with user : {}", id);
        Optional<Customer> customer = customerRepository.findOneCustomerByUser(id);
        return ResponseUtil.wrapOrNotFound(customer);
    }

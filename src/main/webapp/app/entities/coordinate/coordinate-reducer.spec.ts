...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COORDINATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COORDINATE actions', async () => {
      const expectedActions = [
        {
